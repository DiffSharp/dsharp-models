...
type Fire(inChannels:int,
        squeezeChannels: int,
        expand1Channels: int,
        expand3Channels: int) =
    inherit Model()
    let squeeze = Conv2d(inChannels, squeezeChannels, kernelSize=1) --> dsharp.relu
    let expand1 = Conv2d(squeezeChannels, expand1Channels, kernelSize=1) --> dsharp.relu
    let expand3 = Conv2d(squeezeChannels, expand3Channels, kernelSize=3, padding=1 (* "same " *)) --> dsharp.relu
...
type SqueezeNetV1_0(classCount: int) =
    inherit Model()
    let conv1 = Conv2d(3, 96, kernelSize=7, stride=2, padding=3 (* "same " *)) --> dsharp.relu
    ...
    let conv10 = Conv2d(512, classCount, kernelSize=1, stride=1) --> dsharp.relu
...
type SqueezeNetV1_1(classCount: int) =
    inherit Model()
    let conv1 = Conv2d(3, 64, kernelSize=3, stride=2, padding=1 (* "same " *)) --> dsharp.relu
    let maxPool1 = MaxPool2d(kernelSize=3, stride=2)
    let fire2 = Fire(inChannels=64, squeezeChannels=16, expand1Channels=64, expand3Channels=64)
    let fire3 = Fire(inChannels=128, squeezeChannels=16, expand1Channels=64, expand3Channels=64)
    let maxPool3 = MaxPool2d(kernelSize=3, stride=2)
    let fire4 = Fire(inChannels=128, squeezeChannels=32, expand1Channels=128, expand3Channels=128)
    let fire5 = Fire(inChannels=256, squeezeChannels=32, expand1Channels=128, expand3Channels=128)
    let maxPool5 = MaxPool2d(kernelSize=3, stride=2)
    let fire6 = Fire(inChannels=256, squeezeChannels=48, expand1Channels=192, expand3Channels=192)
    let fire7 = Fire(inChannels=384, squeezeChannels=48, expand1Channels=192, expand3Channels=192)
    let fire8 = Fire(inChannels=384, squeezeChannels=64, expand1Channels=256, expand3Channels=256)
    let fire9 = Fire(inChannels=512, squeezeChannels=64, expand1Channels=256, expand3Channels=256)
    let conv10 = Conv2d(512, classCount, kernelSize=1, stride=1) --> dsharp.relu
    let avgPool10 = AvgPool2d(kernelSize=13, stride=1)
    let dropout = Dropout2d(p=0.5)
